...
The `stringr` package gives os tools for working with text strings. 
...
`str_c` or `paste` and `paste0` fra base R
...
##  Time intervals
The difference between to dates/datetimes is a `difftime
```{r}
