...
- To get the element in the first row of the third column in the second matrix you type:
```{r}
e[1, 3, 2]
```
...
## Arrays  
We get problems if we replace the second matrix in the array by a character version of that same matrix:
```{r}
