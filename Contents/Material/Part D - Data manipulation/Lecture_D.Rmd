...
```{r echo=F, out.width='50%', out.extra='style="float:center; padding:5px"'}
knitr::include_graphics("figures/native_pipe_option.png")
```
...
knitr::include_graphics("figures/bind_rows.PNG")
```
...
knitr::include_graphics("figures/mutate_joins.PNG")
```

## "Filtering" joins

```{r echo=F, out.width='80%'}
knitr::include_graphics("figures/filter_joins.PNG")
```
