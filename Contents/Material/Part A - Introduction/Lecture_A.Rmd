...
## Info
* All up-to-date info and material on webpage: 

  [joliencremers.github.io/R-for-BHAS-2023](https://joliencremers.github.io/R-for-BHAS-2023).
...
|Day | Time        | Topic                                           |
|:------------|:------------|:------------------------------------------------|
| *Tuesday*   | 09.00-12.00 | Introduction to R and RStudio                 |
|             | 13.00-15.30 | Datatypes in R and basic syntax                 |
| *Wednesday* | 09.00-12.00 | Reading external data into R                    |
|             | 13.00-15.30 | Data manipulation and tidyverse                 |
| *Thursday*  | 09.00-12.00 | Grouping and summarizing data                   |
|             | 13.00-15.30 | More data manipulation (strings and dates)      |
| *Friday*    | 09.00-10.00 | Introduction to visualization and reports       |
