---
title: "Statistical Programming and Data Manupulation with R"
output: 
...
This dashboard covers the materials for the course Statistical Programming and Data Manupulation with R held in Sarajevo, May 23 - May 26, 2023.
...
| *Thursday*  |                                                 |
| 09.00-12.00 | More data manipulation (strings and dates)      |
|             | *Break*                                         |             
...
install.packages(c("tidyverse", "knitr", "rmarkdown", "haven",
                   ...
                   "printr", "nycflights13", "readxl", "ggplot2", 
                   "kableExtra", "knitr"), 
                 dependencies = TRUE)
```
...
All lectures are in `html` format. Practicals are are provided with hints and answers - choose when to use these!
...
- Part D: Data manipulation and tidyverse
    - [Lecture D](Contents/Material/Part D - Data manipulation/Lecture_D.html){target="_blank"}
    - [Practical D1](Contents/Material/Part D - Data manipulation/Practical_D1.html){target="_blank"}
    - [Practical D2](Contents/Material/Part D - Data manipulation/Practical_D2.html){target="_blank"}
...
- Part E: Strings and dates
    - [Lecture E](Contents/Material/Part E - Strings and dates/Lecture_E.html){target="_blank"}
    - [Practical E1](Contents/Material/Part E - Strings and dates/Practical_E1.html){target="_blank"}
    - [Practical E2](Contents/Material/Part E - Strings and dates/Practical_E2.html){target="_blank"}

- Part F: Summary stats
    - [Lecture F](Contents/Material/Part F - Summary stats/Lecture_F.html){target="_blank"}
    - [Practical F](Contents/Material/Part F - Summary stats/Practical_F.html){target="_blank"}
    - [income.data](Contents/Material/Part F - Summary stats/data/income.data){target="_blank"}
    - [eu_debt.xlsx](Contents/Material/Part F - Summary stats/data/eu_debt.xlsx){target="_blank"}
...
- Part H: Recap
    - [income.xlsx](Contents/Material/Part H - Recap/income.xlsx){target="_blank"}
    - [boys_ID.xlsx](Contents/Material/Part H - Recap/boys_ID.xlsx){target="_blank"}
    - [boys_ID_1.xlsx](Contents/Material/Part H - Recap/boys_ID_1.xlsx){target="_blank"}
    - [boys_ID_2.xlsx](Contents/Material/Part H - Recap/boys_ID_2.xlsx){target="_blank"}
    - [planes.xlsx](Contents/Material/Part H - Recap/planes.xlsx){target="_blank"}
    - [airlines.xlsx](Contents/Material/Part H - Recap/airlines.xlsx){target="_blank"}
    - [flights.xlsx](Contents/Material/Part H - Recap/flights.xlsx){target="_blank"}
    - [Lecture H](Contents/Material/Part H - Recap/summary.html){target="_blank"}
    - [Example data manipulation](Contents/Material/Part H - Recap/Example_data_manipulation.zip){target="_blank"}
