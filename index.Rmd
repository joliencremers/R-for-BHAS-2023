...
- Part E: Strings and dates
    - [Lecture E](Contents/Material/Part E - Strings and dates/Lecture_F.html){target="_blank"}
    - [Practical E1](Contents/Material/Part E - Strings and dates/Practical_F1.html){target="_blank"}
    - [Practical E2](Contents/Material/Part E - Strings and dates/Practical_F2.html){target="_blank"}

- Part F: Summary stats
    - [Lecture F](Contents/Material/Part F - Summary stats/Lecture_E.html){target="_blank"}
    - [Practical F](Contents/Material/Part F - Summary stats/Practical_E.html){target="_blank"}
